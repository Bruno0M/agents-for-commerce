...
- **Desatualizado:** a dev store `afc-store-o7xzc4c2` foi criada e validada ao vivo (03/08/2026), e o catálogo de demo foi publicado nela (`../../catalogo-demo/spec.md`, verificado em 04/08/2026). O formato de `specs`/metafields já pode ser conferido contra a loja real.
